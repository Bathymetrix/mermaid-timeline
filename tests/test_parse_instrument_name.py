...
from mermaid_records.parse_instrument_name import parse_instrument_name


def test_parse_instrument_name_zero_pads_station_suffix() -> None:
...
def test_parse_instrument_name_preserves_existing_zero_padding() -> None:
